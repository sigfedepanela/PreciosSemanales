...
jsonSource_MunicipiosTomadePrecios_2.addFeatures(features_MunicipiosTomadePrecios_2);var lyr_MunicipiosTomadePrecios_2 = new ol.layer.Vector({
            ...
            });var format_PreciosSegundaSemanadeAgostode2018_3 = new ol.format.GeoJSON();
var features_PreciosSegundaSemanadeAgostode2018_3 = format_PreciosSegundaSemanadeAgostode2018_3.readFeatures(json_PreciosSegundaSemanadeAgostode2018_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PreciosSegundaSemanadeAgostode2018_3 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_PreciosSegundaSemanadeAgostode2018_3.addFeatures(features_PreciosSegundaSemanadeAgostode2018_3);var lyr_PreciosSegundaSemanadeAgostode2018_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosSegundaSemanadeAgostode2018_3, 
                style: style_PreciosSegundaSemanadeAgostode2018_3,
                title: '<img src="styles/legend/PreciosSegundaSemanadeAgostode2018_3.png" /> Precios Segunda Semana de Agosto de 2018'
            });

lyr_LimiteDepartamental_0.setVisible(true);lyr_PreciosporDepartamento_1.setVisible(true);lyr_MunicipiosTomadePrecios_2.setVisible(true);lyr_PreciosSegundaSemanadeAgostode2018_3.setVisible(false);
var layersList = [baseLayer,lyr_LimiteDepartamental_0,lyr_PreciosporDepartamento_1,lyr_MunicipiosTomadePrecios_2,lyr_PreciosSegundaSemanadeAgostode2018_3];
...
lyr_PreciosSegundaSemanadeAgostode2018_3.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_PreciosSegundaSemanadeAgostode2018_3.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_PreciosSegundaSemanadeAgostode2018_3.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_PreciosSegundaSemanadeAgostode2018_3.on('precompose', function(evt) {
