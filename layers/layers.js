...
jsonSource_MunicipiosTomadePrecios_3.addFeatures(features_MunicipiosTomadePrecios_3);var lyr_MunicipiosTomadePrecios_3 = new ol.layer.Vector({
            ...
            });var format_PreciosSegundaSemanadeDiciembrede2018_4 = new ol.format.GeoJSON();
var features_PreciosSegundaSemanadeDiciembrede2018_4 = format_PreciosSegundaSemanadeDiciembrede2018_4.readFeatures(json_PreciosSegundaSemanadeDiciembrede2018_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PreciosSegundaSemanadeDiciembrede2018_4 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_PreciosSegundaSemanadeDiciembrede2018_4.addFeatures(features_PreciosSegundaSemanadeDiciembrede2018_4);var lyr_PreciosSegundaSemanadeDiciembrede2018_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosSegundaSemanadeDiciembrede2018_4, 
                style: style_PreciosSegundaSemanadeDiciembrede2018_4,
                title: '<img src="styles/legend/PreciosSegundaSemanadeDiciembrede2018_4.png" /> Precios Segunda Semana de Diciembre de 2018'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_LimiteDepartamental_1.setVisible(true);lyr_PreciosporDepartamento_2.setVisible(true);lyr_MunicipiosTomadePrecios_3.setVisible(true);lyr_PreciosSegundaSemanadeDiciembrede2018_4.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_LimiteDepartamental_1,lyr_PreciosporDepartamento_2,lyr_MunicipiosTomadePrecios_3,lyr_PreciosSegundaSemanadeDiciembrede2018_4];
...
lyr_PreciosSegundaSemanadeDiciembrede2018_4.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_PreciosSegundaSemanadeDiciembrede2018_4.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_PreciosSegundaSemanadeDiciembrede2018_4.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_PreciosSegundaSemanadeDiciembrede2018_4.on('precompose', function(evt) {
