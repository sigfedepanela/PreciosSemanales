...
jsonSource_MunicipiosTomadePrecios_3.addFeatures(features_MunicipiosTomadePrecios_3);var lyr_MunicipiosTomadePrecios_3 = new ol.layer.Vector({
            ...
            });var format_PreciosCuartaSemanadeFebrerode2019_4 = new ol.format.GeoJSON();
var features_PreciosCuartaSemanadeFebrerode2019_4 = format_PreciosCuartaSemanadeFebrerode2019_4.readFeatures(json_PreciosCuartaSemanadeFebrerode2019_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PreciosCuartaSemanadeFebrerode2019_4 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_PreciosCuartaSemanadeFebrerode2019_4.addFeatures(features_PreciosCuartaSemanadeFebrerode2019_4);var lyr_PreciosCuartaSemanadeFebrerode2019_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_PreciosCuartaSemanadeFebrerode2019_4, 
                style: style_PreciosCuartaSemanadeFebrerode2019_4,
                title: '<img src="styles/legend/PreciosCuartaSemanadeFebrerode2019_4.png" /> PreciosCuarta Semana de Febrero de 2019'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_LimiteDepartamental_1.setVisible(true);lyr_PreciosporDepartamento_2.setVisible(true);lyr_MunicipiosTomadePrecios_3.setVisible(true);lyr_PreciosCuartaSemanadeFebrerode2019_4.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_LimiteDepartamental_1,lyr_PreciosporDepartamento_2,lyr_MunicipiosTomadePrecios_3,lyr_PreciosCuartaSemanadeFebrerode2019_4];
...
lyr_PreciosCuartaSemanadeFebrerode2019_4.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_PreciosCuartaSemanadeFebrerode2019_4.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_PreciosCuartaSemanadeFebrerode2019_4.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_PreciosCuartaSemanadeFebrerode2019_4.on('precompose', function(evt) {
