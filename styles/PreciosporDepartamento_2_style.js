...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1475.000000 && value <= 1475.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1475.000000 && value <= 1575.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1575.000000 && value <= 1638.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1638.000000 && value <= 1793.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1793.000000 && value <= 2140.000000) {
            style = [ new ol.style.Style({
