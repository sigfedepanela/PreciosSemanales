...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1292.000000 && value <= 1292.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1292.000000 && value <= 1408.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1408.000000 && value <= 1475.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1475.000000 && value <= 1675.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1675.000000 && value <= 2084.000000) {
            style = [ new ol.style.Style({
