...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1388.000000 && value <= 1403.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1403.000000 && value <= 1616.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1616.000000 && value <= 1755.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1755.000000 && value <= 2068.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2068.000000 && value <= 2182.000000) {
            style = [ new ol.style.Style({
