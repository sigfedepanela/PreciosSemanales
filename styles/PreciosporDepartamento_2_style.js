...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1452.000000 && value <= 1452.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1452.000000 && value <= 1485.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1485.000000 && value <= 1650.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1650.000000 && value <= 1897.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1897.000000 && value <= 2194.000000) {
            style = [ new ol.style.Style({
