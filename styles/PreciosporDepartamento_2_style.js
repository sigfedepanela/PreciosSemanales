...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1317.000000 && value <= 1400.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1400.000000 && value <= 1500.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1500.000000 && value <= 1633.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1633.000000 && value <= 2000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2000.000000 && value <= 2095.000000) {
            style = [ new ol.style.Style({
