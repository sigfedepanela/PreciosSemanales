...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1282.000000 && value <= 1358.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1358.000000 && value <= 1467.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1467.000000 && value <= 1611.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1611.000000 && value <= 1980.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1980.000000 && value <= 2202.000000) {
            style = [ new ol.style.Style({
