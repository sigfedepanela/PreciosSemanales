...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1455.000000 && value <= 1455.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1455.000000 && value <= 1590.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1590.000000 && value <= 1625.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1625.000000 && value <= 1908.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1908.000000 && value <= 2100.000000) {
            style = [ new ol.style.Style({
