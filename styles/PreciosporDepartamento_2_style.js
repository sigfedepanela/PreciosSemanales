...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1312.000000 && value <= 1312.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1312.000000 && value <= 1535.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1535.000000 && value <= 1595.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1595.000000 && value <= 1990.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1990.000000 && value <= 2170.000000) {
            style = [ new ol.style.Style({
