...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1368.000000 && value <= 1368.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1368.000000 && value <= 1565.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1565.000000 && value <= 1675.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1675.000000 && value <= 1954.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1954.000000 && value <= 2114.000000) {
            style = [ new ol.style.Style({
