...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1334.000000 && value <= 1334.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1334.000000 && value <= 1675.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1675.000000 && value <= 1913.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1913.000000 && value <= 2110.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2110.000000 && value <= 2350.000000) {
            style = [ new ol.style.Style({
