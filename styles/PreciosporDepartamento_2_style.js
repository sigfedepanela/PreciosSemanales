...
var style_PreciosporDepartamento_2 = function(feature, resolution){
    ...
    if (value >= 1285.000000 && value <= 1285.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1285.000000 && value <= 1385.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1385.000000 && value <= 1425.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1425.000000 && value <= 1725.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1725.000000 && value <= 2082.000000) {
            style = [ new ol.style.Style({
