...
var style_PreciosporDepartamento_1 = function(feature, resolution){
    ...
    if (value > 1196.000000 && value <= 1402.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1402.800000 && value <= 1609.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1609.600000 && value <= 1816.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1816.400000 && value <= 2023.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2023.200000 && value <= 2230.000000) {
            style = [ new ol.style.Style({
