...
var style_PreciosporDepartamento_1 = function(feature, resolution){
    ...
    if (value > 1197.000000 && value <= 1397.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1397.600000 && value <= 1598.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1598.200000 && value <= 1798.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1798.800000 && value <= 1999.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1999.400000 && value <= 2200.000000) {
            style = [ new ol.style.Style({
